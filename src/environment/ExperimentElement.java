...
public interface ExperimentElement {
	 ...
	 * The GUI gets scaled accordingly to {@link environment.pages.guiElements.InformationSegment#pInfContent}'s width (parentWidth).
	 ...
	 */
	public void save();
	/** Loads the GUI of the experiment element to be displayed in {@link environment.pages.guiElements.InformationSegment#pInfContent}.
	 * This method gets called by {@link environment.pages.guiElements.OptionButton#setOnActionW(ExperimentElement, SettingsPage, InformationSegment)}
	 * if {@link #getBuiltGui()} == false.
